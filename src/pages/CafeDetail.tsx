...
interface CafeDetailData { _id: string; name: string; address?: string; description?: string; averageRating?: number; coverImage?: string; }
...
export default function CafeDetail() {
    ...
    const handleDelete = async () => {
        if (!window.confirm('¿Eliminar este café definitivamente?')) return;
        try {
            const token = await getAccessTokenSilently();
            await axios.delete(
